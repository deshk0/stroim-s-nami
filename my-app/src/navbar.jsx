...
export class Navbar extends React.Component{
    ...
    onClick1(e){
        ...
        const opa3 = document.getElementById('burger-logo')
        ...
        const className3 = "burgermenu-logo-href_active"
        
        opa.classList.toggle(className)
        opa1.classList.toggle(className1)
        opa3.classList.toggle(className3)
        ...
        opa2[5].classList.toggle(className2)
    }

    render(){
        return(
            <nav id="Navbar">
                <a className="Navbar-href" style={{borderBottom:`3px solid ${document.location.href === 'https://stroim-s-nami.com.ua/' ? 'black' : 'transperent'}`}} href="/">Главная</a>
                <a className="Navbar-href" style={{borderBottom:`3px solid ${document.location.href === 'https://stroim-s-nami.com.ua/aboutus' ? 'black' : 'transperent'}`}} href="/aboutus">О нас</a>
                ...
                <a className="Navbar-href" style={{borderBottom:`3px solid ${document.location.href === 'https://stroim-s-nami.com.ua/desivery' ? 'black' : 'transperent'}`}} href="/desivery">Доставка и оплата</a>
                <a className="Navbar-href" style={{borderBottom:`3px solid ${document.location.href === 'https://stroim-s-nami.com.ua/price' ? 'black' : 'transperent'}`}} href="/price">Прайс</a>
                <a className="Navbar-href" style={{borderBottom:`3px solid ${document.location.href === 'https://stroim-s-nami.com.ua/gallery' ? 'black' : 'transperent'}`}} href="/gallery">Фотогалерея</a>
                
                
                <a className="MainHeader-logo-href" href="https://stroim-s-nami.com.ua/">
                ...
                <div id="opa1" className="NavbarMobile-burgerMenu-block">
                    ...
                    <a className="NavbarMobile-burgermenu-link" href="/price">Прайс</a>
                    <a className="NavbarMobile-burgermenu-link" href="/gallery">Фотогалерея</a>
                    <a id="burger-logo" className="burgermenu-logo-href" href="https://stroim-s-nami.com.ua/">
                        <img className="burgermenu-block1-logo" src="/logo.png" alt='logo'></img>
                    </a>
                </div>
            </nav>
        )
